...
<footer className="text-center text-lg-start bg-white text-muted">
    ...
    <div className="container text-center text-md-start mt-5">
      ...
      <div className="row mt-3">
        ...
        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i className="fas fa-home me-3 text-secondary"></i> Bengaluru, Karnataka, India</p>
          <p>
            <i className="fas fa-envelope me-3 text-secondary"></i>
            info@example.com
          </p>
          <p><i className="fas fa-phone me-3 text-secondary"></i> + 80 234 567 88</p>
          <p><i className="fas fa-print me-3 text-secondary"></i> + 80 234 567 89</p>
        </div>
        {/* <!-- Grid column --> */}
      </div>
      {/* <!-- Grid row --> */}
  ...
  {/* <!-- Copyright --> */}
  <div className="text-center p-4" style={{backgroundColor: "#000019"}}>
    © 2021 Copyright:
    <Link className="text-reset fw-bold" to="/">Company.com</Link>
  </div>
  {/* <!-- Copyright --> */}
</footer>
{/* <!-- Footer --> */}
